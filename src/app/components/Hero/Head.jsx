...
const Head = forwardRef(({ theme, z }, ref) => {
  ...
  return (
    <div className="px-5 sm:px-0  h-[calc(100vh-4rem)] sm:h-[calc(100vh-6rem)] leading-none flex flex-col gap-[6vw] pb-[max(50px,2vw)] m14:pb-[4vw] justify-around sm:justify-end ">
      {/* main heading */}

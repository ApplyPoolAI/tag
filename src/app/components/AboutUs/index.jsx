...
export default function AboutUs() {
  ...
  return (
    ...
    >
      <div  ref={aboutSec} className="heroSection sm:h-screen w-full overflow-hidden relative px-5 sm:px-16 2xl:px-32 py-10 sm:py-12 flex flex-col justify-between">
        {/* horizontal scroller */}
        ...
        >
          <div>
            <div className="hidden sm:flex sm:whitespace-nowrap flex-wrap sm:flex-nowrap items-center mt-4 2xl:mt-8">
